...
class HttpPeerSourceTest {
    ...
    void slowDripBodyHitsWholeExchangeDeadline() {
        ...
        var source = new HttpPeerSource(baseUrl, false, new PeerExchange(), Duration.ofMillis(500));
    ...
    void configuredPeerTokenIsAttachedAsBearer() {
        ...
        assertEquals(42L, new HttpPeerSource(baseUrl, false, new PeerExchange(),
    ...
    void aConfiguredPeerReachedOverCleartextGetsNoToken() {
        ...
        assertEquals(42L, new HttpPeerSource(baseUrl, false, new PeerExchange(), policy).height());
        org.junit.jupiter.api.Assertions.assertNull(seen.get(),
